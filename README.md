...
За период прохождения практики были получены навыка вледния такими ресурсами, как Git и GitHub, что позволило загружать собственные проекты в личный репозиторий, а также появилась возможность делиться своими проектами с другими участниками данной платформы.

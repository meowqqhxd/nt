...
Также за период прохождения практики была создана собственная программа по генерации паролей на языке программирования 
```Visual Basic```
с использованием **Windows Forms**, при помощи ранее составленных IDEF0 диаграмм, а точнее ["Контекстной диаграммы"](https://github.com/meowqqhxd/ychebnaya/blob/main/%D0%9A%D0%BE%D0%BC%D0%BF%D0%BE%D0%B7%D0%B8%D1%86%D0%B8%D1%8F.jpg) и ["Декомпозиции"](https://github.com/meowqqhxd/ychebnaya/blob/main/%D0%94%D0%B5%D0%BA%D0%BE%D0%BC%D0%BF%D0%BE%D0%B7%D0%B8%D1%86%D0%B8%D1%8F.jpg). Наглядное представление программы позволило лучше понять её задачу, а также написать код для дальнейшего использования ПО, который был отлично реализован для дальнейшего практичного использования программы пользователем.

За период прохождения практики были получены ценные навыки и опыт владения такими ресурсами, как Git и GitHub, что позволило разобраться с их функционалом, загружать собственные проекты в личный репозиторий, а также появилась возможность делиться своими проектами с другими участниками данной платформы.

...
За период прохождения практики были получены навыка вледния таким ресурсом, как Git и GitHub, что позволило загружать собственные проектыв личный репозиторий, а также появилась возможность делиться своими проектами с другими участниками данной платформы.

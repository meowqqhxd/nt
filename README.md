...
Также за период прохождения практики была создана собственная программа по генерации паролей на языке программирования ```Visual Basic``` с использованием **Windows Forms**. Наглядное представление программы позволило лучше понять её задачу, а также написать код для дальнейшего использования ПО.

За период прохождения практики были получены навыки владения такими ресурсами, как Git и GitHub, что позволило загружать собственные проекты в личный репозиторий, а также появилась возможность делиться своими проектами с другими участниками данной платформы.
